...
class FirstViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        teams.append(Team(rank: 1, name: "KT", wins: 18, losses: 0, gameDiff: 36, streak: 18, img: "kt", players: ktPlayers, fullName: "KT Rolster", teamImage: "kti"))
        teams.append(Team(rank: 2, name: "DWG", wins: 16, losses: 2, gameDiff: 29, streak: 10, img: "dwg", players: dwgPlayers, fullName: "DAMWON Gaming", teamImage: "dwgi"))
        teams.append(Team(rank: 3, name: "DRX", wins: 15, losses: 3, gameDiff: 19, streak: -1, img: "drx", players: drxPlayers, fullName: "DRX", teamImage: "drxi"))
        teams.append(Team(rank: 4, name: "GEN", wins: 14, losses: 4, gameDiff: 19, streak: 4, img: "geng", players: gengPlayers, fullName: "Gen.G", teamImage: "gengi"))
        teams.append(Team(rank: 5, name: "T1", wins: 13, losses: 5, gameDiff: 14, streak: 1, img: "t1", players: t1Players, fullName: "T1", teamImage: "t1i"))
        teams.append(Team(rank: 6, name: "AF", wins: 10, losses: 8, gameDiff: 1, streak: -1, img: "af", players: afPlayers, fullName: "Afreeca Freecs", teamImage: "afi"))
        teams.append(Team(rank: 7, name: "SB", wins: 7, losses: 11, gameDiff: -8, streak: 1, img: "sb", players: sbPlayers, fullName: "Sandbox GAMING", teamImage: "sbi"))
        teams.append(Team(rank: 8, name: "DYN", wins: 5, losses: 13, gameDiff: -12, streak: -1, img: "dyn", players: dynPlayers, fullName: "Team Dynamics", teamImage: "dyni"))
        teams.append(Team(rank: 9, name: "HLE", wins: 2, losses: 16, gameDiff: -26, streak: 1, img: "hle", players: hlePlayers, fullName: "Hanwha Life Esports", teamImage: "hlei"))
        teams.append(Team(rank: 10, name: "SP", wins: 1, losses: 17, gameDiff: -29, streak: -17, img: "sp", players: spPlayers, fullName: "SeolHaeOne Prince", teamImage: "spi"))
    }
